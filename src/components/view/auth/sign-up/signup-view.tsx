  ...
  return (
    <div className="mx-auto flex w-[430px] flex-col justify-center space-y-6 rounded border px-6 py-10 shadow-2xl lg:w-[646px] lg:border-0 lg:p-0 lg:shadow-none">
      <div className="flex flex-col space-y-3 text-center">
        ...
        <h1 className="text-2xl font-bold tracking-tight lg:text-3xl">{t('welcomeBack')}</h1>
        <p className="text-sm font-semibold text-gray-600 lg:text-xl">{t('completeYourData')}</p>{' '}
      </div>
